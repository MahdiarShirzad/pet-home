  ...
  return (
    <div className="flex flex-col items-center gap-2 text-lg">
      <div className="flex items-center gap-3">
        ...
        <p className="text-[37px] font-yekanExtraBold">پیوندها</p>
      </div>
      <div className="font-yekanReg flex flex-col items-center justify-between gap-4 mt-6">
        <NavLink to="/">
          <p className="hover:text-[#FFAA00] ">صفحه اصلی</p>
        </NavLink>
        <NavLink to="/about-us">
          <p className="hover:text-[#FFAA00] ">درباره ما</p>
        </NavLink>
        <NavLink to="/products">
          <p className="hover:text-[#FFAA00] ">محصولات</p>
        </NavLink>
        <NavLink to="contact-us">
          <p className="hover:text-[#FFAA00] ">تماس با ما</p>
        </NavLink>
      </div>
    </div>
  );
