...
const BlogText = () => {
  return (
    <div className=" w-full mt-12 bg-white rounded-3xl px-12 py-8">
      <article className=" font-yekanReg leading-10 text-gray-800 border-b pb-4">
      ...
      <div className="flex justify-between items-center mt-8 font-yekanReg text-sm">
