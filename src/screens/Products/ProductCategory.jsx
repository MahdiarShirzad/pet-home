...
const ProductCategory = ({ categories, handleCategoryToggle }) => {
  return (
    <div className="mt-6">
      <div className="bg-[#FEBF0F26] rounded-3xl flex justify-start px-10 gap-3 py-3 items-center">
        <svg
          width="41"
          height="41"
          viewBox="0 0 41 41"
        ...
        <p className="font-yekanExtraBold text-[24px] text-[#343a40]">
          دسته بندی
        </p>
      </div>
      <div className="w-full rounded-xl bg-white mt-5 py-5 px-6 font-yekanReg text-sm">
        {categories.map((category, index) => (
          <div key={index} className="flex items-center my-3 gap-5">
            <input
