  ...
  return (
    <div className="container max-w-[1200px] mx-auto my-16 flex items-center justify-between">
      <div className="w-1/2">
        ...
        <form
          className="bg-white py-10 w-full mt-6 rounded-3xl flex flex-col gap-8 px-16"
          action=""
        >
          <input
            className="bg-gray-200 rounded-2xl py-3 px-4 font-yekanReg text-gray-700 focus:outline-none focus:placeholder:opacity-0 focus:outline-black"
            type="text"
            name="username"
            id=""
            placeholder="نام کاربری یا تلفن همراه"
          />
          <input
            className="bg-gray-200 rounded-2xl py-3 px-4 font-yekanReg text-gray-700 focus:outline-none focus:placeholder:opacity-0 focus:outline-black"
            type="password"
            ...
            placeholder="رمزعبور"
          />
          <div className="flex items-center justify-between font-yekanReg">
            ...
            <NavLink to="/sign-up">
              <p className="hover:text-[#febf0f]">ثبت نام</p>
            </NavLink>
          </div>
        </form>
      </div>
