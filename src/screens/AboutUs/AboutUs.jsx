...
import bg from "../../assets/img/bg_cunter.png";
...
const AboutUs = () => {
  return (
    <div className="container max-w-[1200px] mx-auto my-10">
      <div className="] flex items-center justify-between mx-auto">
        <div className="w-[55%]">
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-[39px] font-yekanExtraBold text-[#343a40] ">
              درباره ما
            </p>
          </div>
          ...
          <div className="flex justify-between items-center mt-8">
            <div className="w-[210px] h-[90px] flex items-center justify-between">
              ...
              <div className="flex flex-col gap-2 ">
                ...
                <p className="text-[#febf0f] font-yekanReg">
                  {" "}
                  مدیریت Pet Home{" "}
                </p>
              </div>
      ...
      <div
        className="text-center flex items-center justify-between px-28 rounded-3xl text-white font-yekanReg py-10 mt-12 bg-[#343a40]"
        style={{
          backgroundImage: `url(${bg})`, // Assuming 'bg' contains the path to your image
          backgroundSize: "cover", // Optional: Adjust based on your design needs
          backgroundRepeat: "no-repeat", // Optional: Adjust based on your design needs
        }}
      >
        <div>
          <p>محصولات</p>
          <p className=" font-yekanExtraBold text-3xl mt-4">61</p>
        </div>
        <div>
          <p>سابقه فعالیت</p>
          <p className=" font-yekanExtraBold text-3xl mt-4">12 سال</p>
        </div>
        <div>
          <p>مشتریان راضی</p>
          <p className=" font-yekanExtraBold text-3xl mt-4">95 نفر</p>
        </div>
        <div>
          <p>اعضای تیم</p>
          <p className=" font-yekanExtraBold text-3xl mt-4">23 نفر</p>
        </div>
      </div>
      <CommonQuestions />
      <TeamMembers />
