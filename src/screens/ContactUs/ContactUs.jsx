    ...
    <div className="container max-w-[1200px] mx-auto my-10">
      ...
      <div>
        <div className="flex items-center gap-3 mb-3">
          ...
          <p class="text-[39px] font-yekanExtraBold text-[#343a40] ">
            با ما در ارتباط باشید
          </p>
        </div>
        <p className="font-yekanReg">
          لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم برای صنعت چاپ
        </p>
        <div className="flex flex-wrap items-center justify-between mt-10">
          <div className="group rounded-3xl w-[350px] py-8 transition-colors duration-500 cursor-pointer">
            <div className="flex flex-col justify-center items-center bg-white rounded-3xl py-8 hover:bg-[#FEBF0F1A]">
              <div className="bg-[#FEBF0F1A] p-6 rounded-full group-hover:bg-white">
                <svg
                  width="38"
                  height="38"
                  viewBox="0 0 38 38"
                ...
                >
                  ...
                  >
                    <path
                      d="M32.6482 13.3792C30.9857 6.06421 24.6049 2.77087 18.9999 2.77087C18.9999 2.77087 18.9999 2.77087 18.9841 2.77087C13.3949 2.77087 6.99824 6.04837 5.33574 13.3634C3.48324 21.5334 8.48657 28.4525 13.0149 32.8067C14.6932 34.4217 16.8466 35.2292 18.9999 35.2292C21.1532 35.2292 23.3066 34.4217 24.9691 32.8067C29.4974 28.4525 34.5007 21.5492 32.6482 13.3792ZM18.9999 21.3117C16.2449 21.3117 14.0124 19.0792 14.0124 16.3242C14.0124 13.5692 16.2449 11.3367 18.9999 11.3367C21.7549 11.3367 23.9874 13.5692 23.9874 16.3242C23.9874 19.0792 21.7549 21.3117 18.9999 21.3117Z"
                      fill="#FFAA00"
                    ></path>
                  </svg>
                </svg>
              </div>
              <p className="mt-4 font-yekanExtraBold text-2xl">آدرس ما:</p>
              <p className="mt-3 font-yekanReg">
          ...
          <div className="group rounded-3xl w-[350px] py-8 transition-colors duration-500 cursor-pointer">
            <div className="flex flex-col justify-center items-center bg-white rounded-3xl py-8 hover:bg-[#FEBF0F1A]">
              <div className="bg-[#FEBF0F1A] p-6 rounded-full group-hover:bg-white">
                ...
                >
                  <path
                    d="M26.9165 5.54163H11.0832C6.33317 5.54163 3.1665 7.91663 3.1665 13.4583V24.5416C3.1665 30.0833 6.33317 32.4583 11.0832 32.4583H26.9165C31.6665 32.4583 34.8332 30.0833 34.8332 24.5416V13.4583C34.8332 7.91663 31.6665 5.54163 26.9165 5.54163ZM27.6607 15.1841L22.7048 19.1425C21.6598 19.9816 20.3298 20.3933 18.9998 20.3933C17.6698 20.3933 16.324 19.9816 15.2948 19.1425L10.339 15.1841C9.83234 14.7725 9.75317 14.0125 10.149 13.5058C10.5607 12.9991 11.3048 12.9041 11.8115 13.3158L16.7673 17.2741C17.9707 18.24 20.0132 18.24 21.2165 17.2741L26.1723 13.3158C26.679 12.9041 27.439 12.9833 27.8348 13.5058C28.2465 14.0125 28.1673 14.7725 27.6607 15.1841Z"
                    fill="#FFAA00"
                  ></path>
                </svg>
              </div>
              <p className="mt-4 font-yekanExtraBold text-2xl">
                پست الکترونیکی:
              </p>
              <p className="mt-3 font-yekanReg">info@pet-home.com</p>
            </div>
          </div>
          <div className="group rounded-3xl w-[350px] py-8 transition-colors duration-500 cursor-pointer">
            <div className="flex flex-col justify-center items-center bg-white rounded-3xl py-8 hover:bg-[#FEBF0F1A]">
