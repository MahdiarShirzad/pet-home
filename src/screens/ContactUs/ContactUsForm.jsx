...
import img from "../../assets/img/contact-us.png";
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="w-1/2">
        ...
        <p className="font-yekanReg">میزبان صدای گرم شما هستیم ...</p>
        <div className="flex flex-col gap-10 w-full my-10 px-8">
          <input
            className="px-6 py-4 rounded-2xl font-yekanReg focus:outline-none focus:outline-orange-300 focus:placeholder:opacity-0"
            type="email"
          ...
          />
          <textarea
            className="px-6 py-4 rounded-2xl font-yekanReg focus:outline-none h-28 focus:outline-orange-300 focus:placeholder:opacity-0"
            name=""
          ...
          <button class="py-3  px-5 gap-1 mx-2 rounded-full flex justify-center items-center  text-white bg-gray-800 hover:bg-[#FFAA00] cursor-pointer transition-colors duration-400  font-yekanReg text-[14px]  w-28">
            ارسال پیام
          </button>
        </div>
      </div>
